...
const bancoCompleto = [
  {
    ...
    "erradas": [
      "demonstrar aderência ao plano, independentemente do resultado observado.",
      "confirmar conformidade com requisitos sem apoiar decisões sobre risco.",
      "registrar defeitos sem avaliar qualidade ou risco do objeto de teste."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "teste e depuração são atividades equivalentes, variando apenas o responsável.",
      "a depuração confirma o comportamento esperado; o teste corrige o defeito.",
      "o teste localiza a causa no código; a depuração apenas evidencia a falha."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "um resultado aprovado substitui revisão de requisitos em funcionalidades críticas.",
      "uma verificação apenas registra conformidade, sem questionar ambiguidades.",
      "uma correção em produção identifica problema depois do impacto no usuário."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "um resultado aprovado substitui revisão de requisitos em funcionalidades críticas.",
      "uma correção em produção identifica problema depois do impacto no usuário.",
      "um teste repetido sem análise aumenta esforço, mas não melhora informação."
    ],
    "explicacao": "Testes são necessários para reduzir riscos, encontrar defeitos cedo, aumentar confiança e apoiar decisões de qualidade."
  },
  {
  ...
  },
  {
    ...
    "erradas": [
      "testes são garantia da qualidade; controle da qualidade foca somente processos.",
      "garantia da qualidade detecta defeitos no produto; testes definem processos.",
      "testes pertencem à garantia da qualidade, mas não ao controle da qualidade."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "defeitos não se agrupam.",
      "teste independe do contexto.",
      "testes exaustivos são viáveis."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "porque restrições de tempo eliminam a necessidade de análise de risco.",
      "porque a criticidade altera somente a documentação, não a abordagem.",
      "porque técnicas e prioridades independem do domínio de negócio."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "porque restrições de tempo eliminam a necessidade de análise de risco.",
      "porque a criticidade altera somente a documentação, não a abordagem.",
      "porque o mesmo processo deve ser repetido em todos os produtos."
    ],
    "explicacao": "O CTFL enfatiza que teste depende do contexto. Um sistema crítico, um MVP e um produto regulado exigem abordagens diferentes."
  },
  {
  ...
  },
  {
    ...
    "erradas": [
      "planilhas financeiras, campanhas de divulgação e chamados de suporte.",
      "atas administrativas, cronogramas gerais e documentos de contratação.",
      "artefatos de negócio sem relação direta com planejamento ou execução."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "priorizar casos por ordem de criação, sem avaliar impacto de mudança.",
      "registrar defeitos, mas sem indicar quais requisitos foram afetados.",
      "substituir métricas de cobertura por uma lista de funcionalidades."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "priorizar casos por ordem de criação, sem avaliar impacto de mudança.",
      "registrar defeitos, mas sem indicar quais requisitos foram afetados.",
      "reduzir comunicação ao manter relações apenas no plano de projeto."
    ],
    "explicacao": "A rastreabilidade ajuda a entender o que foi coberto, o que foi afetado por uma mudança e como resultados se relacionam aos requisitos."
  },
  {
    ...
    "erradas": [
      "priorizar casos por ordem de criação, sem avaliar impacto de mudança.",
      "registrar defeitos, mas sem indicar quais requisitos foram afetados.",
      "aumentar a quantidade de testes, sem relacioná-los aos requisitos."
    ],
    "explicacao": "A rastreabilidade ajuda a entender o que foi coberto, o que foi afetado por uma mudança e como resultados se relacionam aos requisitos."
  },
  {
  ...
  },
  {
    ...
    "erradas": [
      "testador define a estratégia organizacional; gerente corrige defeitos.",
      "desenvolvedor controla testware; gerente de teste valida o negócio.",
      "gerente de teste executa todos os casos; testador aprova orçamento."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "isolamento da equipe, execução mecânica e ausência de questionamento.",
      "comunicação limitada, foco apenas em ferramentas e baixa colaboração.",
      "postura de confirmação, pouca curiosidade e pouca análise crítica."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "qualidade fica restrita ao testador, reduzindo participação do negócio.",
      "as atividades de teste começam apenas quando o incremento está pronto.",
      "desenvolvedores deixam de testar para evitar sobreposição de papéis."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "garante que defeitos não serão introduzidos após a execução dos testes.",
      "é obrigatória em todos os níveis e não possui desvantagens práticas.",
      "elimina o viés completamente e dispensa colaboração com a equipe."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "define apenas a ferramenta de automação, sem afetar níveis ou artefatos.",
      "afeta o cronograma, mas não altera momento de feedback ou testes.",
      "determina que todos os testes ocorram somente no final do ciclo."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "define apenas a ferramenta de automação, sem afetar níveis ou artefatos.",
      "afeta o cronograma, mas não altera momento de feedback ou testes.",
      "limita os testes a execução manual, independentemente do modelo."
    ],
    "explicacao": "Modelos sequenciais, iterativos, ágeis e DevOps influenciam momento, escopo, automação, documentação e feedback dos testes."
  },
  {
  ...
  },
  {
    ...
    "erradas": [
      "postergar objetivos de teste até que todos os defeitos sejam corrigidos.",
      "desvincular os testes da base de teste para ganhar independência.",
      "substituir rastreabilidade por comunicação informal da equipe."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "estratégias que evitam exemplos antes de implementar a funcionalidade.",
      "abordagens em que os testes são escritos somente após todos os defeitos.",
      "testes de regressão executados apenas depois da entrega em produção."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "reduzir automação, pois a entrega contínua depende apenas de revisões.",
      "substituir monitoramento por testes manuais executados no final.",
      "diminuir rastreabilidade para acelerar aprovações de mudança."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "transferir testes para a etapa final, reduzindo feedback durante o SDLC.",
      "remover atividades de teste dos refinamentos para ganhar velocidade.",
      "focar apenas execução dinâmica, evitando análise estática inicial."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "comparando equipes para selecionar culpados por defeitos recorrentes.",
      "repetindo o mesmo processo, mesmo quando surgem bloqueios conhecidos.",
      "registrando apenas métricas finais, sem definir ações de melhoria."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "teste funcional de regra de negócio.",
      "teste de confirmação de defeito.",
      "teste estrutural de ramificação."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "teste funcional de regra de negócio.",
      "teste estrutural de ramificação.",
      "teste de regressão de interface."
    ],
    "explicacao": "Tipos de teste avaliam características como funcionalidade, desempenho, segurança, usabilidade, compatibilidade e outras qualidades."
  },
  {
  ...
  },
  {
    ...
    "erradas": [
      "teste de componente e teste exploratório.",
      "teste de confirmação e teste de sistema.",
      "teste de regressão e teste de aceitação."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "criação de critérios de aceite para uma história ainda não entregue.",
      "primeira implementação de uma funcionalidade sem sistema anterior.",
      "execução de teste estático antes de existir qualquer mudança."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "defeitos em produção, incidentes de usuário e métricas de suporte.",
      "apenas código compilado, excluindo requisitos e documentação.",
      "somente interfaces finais, sem histórias, modelos ou planos."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "executar o sistema em produção antes que os requisitos estejam revisados.",
      "substituir o teste dinâmico por revisão de resultados executados.",
      "corrigir automaticamente o código sem participação dos autores."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "teste estático executa o software; teste dinâmico revisa documentos sem execução.",
      "ambos exigem execução do objeto de teste, mas produzem evidências diferentes.",
      "teste estático é usado apenas em código; teste dinâmico apenas em planos."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "reduzir comunicação com stakeholders para evitar mudanças de escopo.",
      "validar apenas requisitos já implementados para evitar retrabalho.",
      "postergar comentários até a entrega final, concentrando decisões."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "reduzir comunicação com stakeholders para evitar mudanças de escopo.",
      "validar apenas requisitos já implementados para evitar retrabalho.",
      "substituir revisão por execução de teste depois da implementação."
    ],
    "explicacao": "Feedback cedo ajuda a alinhar entendimento, prevenir defeitos e reduzir custos de correção."
  },
  {
  ...
  },
  {
    ...
    "erradas": [
      "preparar massa, executar script, registrar evidência e retestar correção.",
      "planejar release, implantar build, monitorar produção e fechar chamados.",
      "escrever requisito, estimar custo, aprovar orçamento e contratar equipe."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "uma revisão informal sempre exige papéis formais e métricas obrigatórias.",
      "revisões técnicas são sempre menos estruturadas que revisões informais.",
      "uma inspeção dispensa preparação individual e registro de achados."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "uma revisão informal sempre exige papéis formais e métricas obrigatórias.",
      "revisões técnicas são sempre menos estruturadas que revisões informais.",
      "walkthrough e inspeção diferem apenas pelo nome usado pela equipe."
    ],
    "explicacao": "Tipos de revisão variam em objetivo, formalidade, papéis, documentação e preparação."
  },
  {
  ...
  },
  {
    ...
    "erradas": [
      "manter comentários genéricos, sem evidência ou indicação de localização.",
      "evitar critérios de revisão para não limitar a criatividade da equipe.",
      "iniciar a reunião sem preparação e decidir tudo durante a discussão."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "caixa-preta, caixa-branca e experiência se diferenciam apenas pela ferramenta.",
      "caixa-preta usa código; caixa-branca usa requisitos; experiência usa métricas.",
      "caixa-branca usa critérios de aceite; caixa-preta usa cobertura de instrução."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "menor que 18, de 18 a 64, 65 ou maior.",
      "até 18, de 19 a 65, maior que 65.",
      "menor que 18, exatamente 18, exatamente 65."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "códigos com 7 ou 8 caracteres.",
      "códigos vazios ou com 8 caracteres.",
      "códigos com 8 a 10 caracteres."
    ],
  ...
  },
  {
    ...
    "assunto": "Particionamento de equivalência",
    "nivel": "K3",
    "enunciado": "Uma nota deve estar entre 0 e 10. Qual escolha cobre uma partição inválida abaixo do limite?",
    "correta": "-1.",
    "erradas": [
      "0.",
      "5.",
  ...
  },
  {
    ...
    "erradas": [
      "preenchido com uma letra e preenchido com cem letras.",
      "somente letras maiúsculas e somente letras minúsculas.",
      "nome com acento e nome sem acento."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "cliente premium com compra de R$ 200.",
  ...
  },
  {
    ...
    "erradas": [
      "idade 60 e valor 500 mil.",
      "idade 40 e valor 500 mil.",
      "idade 59 e valor 499 mil."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "aberto → fechado sem resolução.",
      "fechado → em atendimento.",
      "resolvido → aberto sem reabertura."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "para confirmar que todos os estados válidos foram exercitados.",
      "para reduzir a necessidade de testar fluxos principais.",
      "para substituir tabelas de decisão em regras com combinações."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "se todas as regras de negócio foram revisadas por especialistas.",
      "se cada requisito possui ao menos um caso de teste associado.",
      "se todas as partições de entrada foram combinadas entre si."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "as instruções executáveis, independentemente dos resultados das decisões.",
      "as classes válidas e inválidas definidas pela especificação.",
      "os cenários de usuário descritos nos critérios de aceite."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "confirmar valor para o usuário sem precisar analisar a estrutura do código.",
      "substituir completamente técnicas de caixa-preta em regras de negócio.",
      "garantir cobertura funcional total apenas com requisitos e histórias."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "confirmar valor para o usuário sem precisar analisar a estrutura do código.",
      "substituir completamente técnicas de caixa-preta em regras de negócio.",
      "validar usabilidade e aceitação sem execução de caminhos estruturais."
    ],
    "explicacao": "Cobertura estrutural ajuda a descobrir lacunas, mas cobertura alta não garante que todas as regras de negócio estejam corretas."
  },
  {
  ...
  },
  {
    ...
    "erradas": [
      "o testador evita novas ideias para preservar comparabilidade entre ciclos.",
      "todos os testes são projetados antecipadamente e executados sem adaptação.",
      "a investigação só ocorre depois que todos os casos planejados terminam."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "seguir passos detalhados e imutáveis, com resultados esperados para cada ação.",
      "derivar automaticamente casos a partir de todos os caminhos do código.",
      "usar somente experiência individual, sem pontos previamente definidos."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "para transformar a história em documentação técnica sem critérios de aceite.",
      "para reduzir a participação do negócio e acelerar a escrita dos testes.",
      "para separar implementação, teste e negócio em etapas independentes."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "Dado um usuário ativo, quando informar senha incorreta, então o acesso deve ser concedido.",
      "Dado um usuário ativo, quando informar senha correta, então o acesso deve ser negado.",
      "Dado qualquer usuário, quando informar qualquer senha, então o sistema deve liberar acesso."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "Dado aluno matriculado, quando solicitar comprovante, então o sistema mostra erro genérico.",
      "Dado aluno não localizado, quando solicitar comprovante, então o sistema gera PDF.",
      "Dado aluno matriculado, quando abrir a tela, então o comprovante pode ou não ser gerado."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "Dado cliente comum e compra de R$ 250, quando calcular frete, então o frete deve ser R$ 0.",
      "Dado cliente premium e compra de R$ 150, quando calcular frete, então o frete deve ser R$ 0.",
      "Dado cliente premium e compra de R$ 250, quando calcular frete, então o frete deve ser maior que R$ 0."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "Dado e-mail não cadastrado, quando solicitar recuperação, então o sistema envia link válido.",
      "Dado e-mail cadastrado, quando solicitar recuperação, então o sistema exibe a senha atual.",
      "Dado e-mail cadastrado, quando solicitar recuperação, então o link nunca expira."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "somente testadores, para evitar influência do negócio nos exemplos.",
      "somente desenvolvedores, para tornar os exemplos tecnicamente precisos.",
      "somente gerentes, para acelerar a aprovação dos critérios."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "transformar expectativas em descrições abertas, sem resultado esperado.",
      "substituir critérios de aceite por testes criados após a entrega.",
      "produzir documentação técnica sem envolver negócio e testadores."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "defeitos conhecidos, alterações de código, scripts finais e evidências de execução.",
      "resultados obtidos, logs de produção, métricas de suporte e chamados encerrados.",
      "requisitos aprovados, código-fonte, releases anteriores e manual do usuário."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "apenas executando casos prontos, sem contribuir com riscos ou dependências.",
      "estimando esforço depois da execução, para não influenciar o planejamento.",
      "substituindo o planejamento da equipe por uma lista de defeitos antigos."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "critérios de entrada indicam quando encerrar; critérios de saída indicam quando começar.",
      "entrada e saída são definidos após a execução, com base nos defeitos encontrados.",
      "ambos definem somente prioridade de defeitos, não início ou término."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "critérios de entrada indicam quando encerrar; critérios de saída indicam quando começar.",
      "entrada e saída são definidos após a execução, com base nos defeitos encontrados.",
      "critérios de saída substituem métricas e dispensam análise de risco."
    ],
    "explicacao": "Critérios de entrada e saída tornam a decisão mais objetiva e ajudam a controlar risco e progresso."
  },
  {
  ...
  },
  {
    ...
    "erradas": [
      "usar somente a quantidade de telas como referência.",
      "copiar prazo de outro projeto sem comparar contexto.",
      "estimar depois da execução para reduzir incerteza."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "cadastro raramente usado e sem histórico de defeitos.",
      "ajuste visual de baixa visibilidade para poucos usuários.",
      "relatório interno com baixo impacto e alternativa manual."
    ],
  ...
  },
  {
    ...
    "erradas": [
      ...
      "o teste criado por último, independentemente do risco.",
      "o teste com menor número de passos."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "começar por cenários raros e dependentes de massa especial.",
      "executar primeiro casos cosméticos de baixa prioridade.",
      "priorizar relatórios que dependem de integração ainda indisponível."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "a melhoria estética.",
      "a funcionalidade sem uso recente.",
      "a alteração de texto sem impacto legal."
    ],
  ...
  },
  {
    ...
    "correta": "ordem alfabética do título.",
    "erradas": [
      "impacto de negócio.",
  ...
  },
  {
    ...
    "erradas": [
      "a pirâmide recomenda substituir testes de componente por testes ponta a ponta.",
      "a base representa testes manuais exploratórios e o topo testes unitários.",
      "quanto mais alto o nível, mais rápido e barato tende a ser o teste."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "organizar testes somente por ferramenta usada e linguagem de programação.",
      "classificar defeitos por severidade, prioridade e responsável técnico.",
      "determinar automaticamente a quantidade exata de testes por release."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "pela quantidade de casos de teste planejados para a funcionalidade.",
      "pelo custo da ferramenta usada para automatizar a verificação.",
      "pela ordem em que o requisito aparece no backlog do produto."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "risco de produto trata recursos da equipe; risco de projeto trata funcionalidade.",
      "risco de projeto afeta a qualidade do sistema; risco de produto afeta o prazo.",
      "riscos de projeto e produto são sinônimos no planejamento de teste."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "executando primeiro os testes mais simples, sem considerar impacto.",
      "priorizando casos por ordem de criação, para evitar subjetividade.",
      "substituindo análise de risco por execução exaustiva dos testes."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "diminuir cobertura nas áreas críticas para executar mais casos simples.",
      "substituir revisão de requisitos por execução aleatória de testes.",
      "aceitar todos os riscos e reduzir a documentação dos defeitos."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "nome do testador, cor da tela, linguagem usada e quantidade de reuniões.",
      "opiniões informais, satisfação da equipe e ordem dos itens do backlog.",
      "documentos assinados, organograma do projeto e horas administrativas."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "apresentar todos os detalhes técnicos igualmente para qualquer público.",
      "listar somente casos aprovados, sem mencionar riscos ou defeitos.",
      "substituir recomendações por quantidade de telas visitadas."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "“o sistema foi testado, sem necessidade de detalhar bloqueios”.",
      "“a equipe testou bastante, mas ainda não sabemos os riscos”.",
      "“a cobertura parece adequada, apesar de não haver métricas”."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "permitindo alteração livre de scripts durante a execução sem controle.",
      "usando sempre o ambiente mais recente, mesmo sem registrar diferenças.",
      "controlando apenas documentos finais, sem relacionar itens de teste."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "resumo do problema, mas sem passos nem resultado esperado.",
      "descrição do impacto, mas sem ambiente e sem evidências.",
      "passos gerais, sem dados usados nem resultado obtido."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "somente a data em que a falha foi observada.",
      "apenas a descrição geral da funcionalidade.",
      "o nome do responsável pela correção, se conhecido."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "registrar apenas “cálculo incorreto no total”.",
      "informar que o cálculo falhou, sem dados de entrada.",
      "descrever a falha sem indicar total esperado e obtido."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "escrever em tom genérico para evitar muitos detalhes.",
      "omitir dados usados quando a falha parece evidente.",
      "registrar a falha sem anexos para acelerar a triagem."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "ferramentas de gestão executam todos os testes sem necessidade de testware.",
      "ferramentas de gestão corrigem defeitos automaticamente durante a execução.",
      "ferramentas de teste substituem estratégia, análise e julgamento humano."
    ],
  ...
  },
  {
    ...
    "erradas": [
      "benefício: corrige defeitos automaticamente; risco: aumenta cobertura estática.",
      "benefício: remove necessidade de dados; risco: impede regressão automatizada.",
      "benefício: garante ausência de defeitos; risco: reduz feedback do pipeline."
    ],
...
function inicializarTema() {
  const temaSalvo = localStorage.getItem("temaQuizCTFL") || "claro";
...
function alternarTema() {
  ...
  localStorage.setItem("temaQuizCTFL", escuro ? "escuro" : "claro");
  atualizarBotaoTema();
}
...
function atualizarBotaoTema() {
  ...
  btnTema.setAttribute("aria-label", escuro ? "Alternar para modo claro" : "Alternar para modo escuro");
}
